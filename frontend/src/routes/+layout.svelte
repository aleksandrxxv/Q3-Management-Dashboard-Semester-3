...
<div class="p-6 border-b border-slate-800 flex items-center gap-3">
  <img src={logo} alt="Q3 Maintenance Software" class="h-10" />
</div>
    ...
    <nav class="flex-1 mt-6 px-4 space-y-2 text-sm font-medium">
      <a
        ...
        class:text-gray-400={!$page.url.pathname.startsWith('/machines')}
      >
      ...
      <a
        ...
        class:text-gray-400={!$page.url.pathname.startsWith('/molds')}
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
             stroke-width="2" stroke="currentColor" class="w-5 h-5">
  ...
  <div class="flex-1 flex flex-col">
    <!-- 🧭 Top Navbar -->
    <header class="flex items-center justify-between px-6 py-3 bg-slate-900 text-white border-b-4">
